...
async def check_resource_constraints(namespace: str) -> Dict[str, Any]:
    ...
    return await check_resource_constraints_impl(namespace, k8s_core_api)
...
async def investigate_tls_certificate_issues(
    ...
    """
    from tools.certificate_tools import investigate_tls_certificate_issues_impl
    return await investigate_tls_certificate_issues_impl(
        time_range,
        max_namespaces,
        focus_on_system_namespaces,
        k8s_core_api=k8s_core_api,
        k8s_custom_api=k8s_custom_api,
        list_namespaces=list_namespaces,
        detect_tekton_namespaces=detect_tekton_namespaces,
        list_pods_in_namespace=list_pods_in_namespace,
        smart_summarize_pod_logs=smart_summarize_pod_logs,
    ...
    try:
        ...
        if len(prioritized_pods) > max_pods:
            ...
            for pod in prioritized_pods:
                ...
                prefix = re.sub(r'-[a-zA-Z0-9]{4,}$', '', prefix)
...
async def check_cluster_certificate_health(
    ...
    return await check_cluster_certificate_health_impl(
        ...
        include_system_certs=include_system_certs,
...
async def live_system_topology_mapper(
    ...
    """
    from tools.topology_tools import live_system_topology_mapper_impl
    return await live_system_topology_mapper_impl(
        k8s_core_api=k8s_core_api,
        k8s_custom_api=k8s_custom_api,
        k8s_apps_api=k8s_apps_api,
        k8s_storage_api=k8s_storage_api,
        k8s_batch_api=k8s_batch_api,
...
async def predictive_log_analyzer(
    ...
    """
    from tools.prediction_tools import predictive_log_analyzer_impl
    return await predictive_log_analyzer_impl(
        prediction_window,
        ...
        list_namespaces=list_namespaces,
        detect_tekton_namespaces=detect_tekton_namespaces,
        get_namespace_events_as_dicts_impl=_get_namespace_events_as_dicts_impl,
    )
